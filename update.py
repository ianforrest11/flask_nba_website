        ...
        try:
            ...
            for j in range(len(row)):
                try:
                    ...
                    column = columns[j]
                    # insert float and int data
                    if database_record != up_to_date_record and type(up_to_date_record) != str:
                        ...
                        f.close()
                    # insert string data
                    elif database_record != up_to_date_record and type(up_to_date_record) == str:
                        c.execute('''UPDATE player_stats_2122
                                    SET {} = '{}'
                                    WHERE player_id = {};
                                    '''.format(column, up_to_date_record, id))     
                    ...
                    with open('error_file.log', 'a') as error_file:
                        error_file.write('Issue with row ' + str(i) + ' at ' + now + '. Check code in row ' + str(error_row) + ' of update.py' + '\n')
